  ...
  <div class="wrapper">
    <div class="content">
      ...
      <li class="collection-hero storytelling">
        <a href="<?php echo( $site->url())?>/storytelling">
          <div class="scroll-description">
      ...
      <li class="collection-hero remakes">
        <a href="<?php echo( $site->url())?>/remakes">
          <div class="scroll-description">
            <h1>Chart Remakes</h1>
      ...
      <li class="collection-hero tools">
        <a href="<?php echo( $site->url())?>/tools">
          <div class="scroll-description">
      ...
      <li class="collection-hero open-source">
        <a href="<?php echo( $site->url())?>/open-source">
          <div class="scroll-description">
            <h1>Open Source</h1>
      ...
      <li class="collection-hero journalism">
        <a href="<?php echo( $site->url())?>/journalism">
          <div class="scroll-description">
      ...
      <li class="collection-hero climate-change">
        <a href="<?php echo( $site->url())?>/climate-change">
          <div class="scroll-description">
