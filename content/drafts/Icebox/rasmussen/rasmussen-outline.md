We've recently launched an interactive scatter plot which shows the number of people employed in occupations in the US against the median salary for those occupations.  
